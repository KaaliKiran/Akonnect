...
Note: Please Enter the Accurate Details as per I94 Copy and please click on the Proceed Button if you wish to extend the workpermit.If So, please upload the appropriate Artifacts from the Upload Section
<table border="0" cellspacing="0" cellpadding="5">
<tr>
<td valign="top">I94 Expiry Date :</td>
...
<td>
<td valign="top">Petition Expiry Date :</td>
...
<img src="../images/date_icon.gif" alt="" width="22" height="20" border="0" class="element12pxmid" onclick="document.iform.accstdat.click();" /><span id="txtHint6"></span></td>

</tr>
<tr>
<td valign="top">Departure Number : </td>
...
<td>&nbsp;</td>
<td valign="top">Birth Date : yyyy-mm-dd</td>
...
<td width="20">&nbsp;</td>
<td valign="top">First Name (Given) :</td>
...
<tr>
<td colspan="4">Do you want an extension? 
