...
function init() {
	calendar.set("travelstart");
	calendar.set("travelend");
	calendar.set("emphiredate");
	calendar.set("currentpos");
	calendar.set("expdate");
}
...
<table width="1145" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<table border="0" border="0" cellspacing="0" cellpadding="0" width="1180">	    
		...
		<tr>
		    <td>
                <table border="0" border="0" cellspacing="0"  RULES=ROWS FRAME=BOX cellpadding="0"> 
        			 <tr>
...
<table border="0"  RULES=COLS FRAME=BOX width="88%" cellpadding="2">
	<tr>
		<th width="101">&nbsp;&nbsp;&nbsp; SL NO&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		</th>
...
<p>&nbsp;</p>
<table border="1" width="87%" RULES=COLS FRAME=BOX>
	<tr>
...
<table border="1" width="87%">
	<tr>
		<th><font color="#C0C0C0">for</font> <font color="#C0C0C0">SBR 
		TECHNOLOGY SERVICES</font><p>SACHIN SARATHY</p>
		<p><font face="Arial Narrow" color="#C0C0C0">AUTHORIZED PERSONNEL</font></p>
		<p>&nbsp;</th>
	</tr>
</table>
<p>&nbsp;</p>
